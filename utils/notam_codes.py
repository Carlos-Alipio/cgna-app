...
NOTAM_SUBJECT = {
    ...
    'PB': 'Chegada padrão por regras de voo visual',
    'PC': 'Procedimentos de contingência',
    'PD': 'Saída padrão por instrumentos',
    'PE': 'Saída padrão por regras de voo visual',
    ...
    'CD': 'Comunicação por ligação de dados controlador-piloto',
    ...
    'IU': 'Sistema de pouso por instrumentos Categoria III',
    ...
    'NM': 'Radio farol onidirecional em VHF/Equipamento radiotelemétrico',
...
NOTAM_CONDITION = {
    ...
    'CD': 'Desativado',
    'CE': 'Montado',
    'CF': 'Frequência(s) de operaçã omodificada(s) para',
    'CG': 'Reduzido para',
    'CH': 'Modificado',
