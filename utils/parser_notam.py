...
# ==============================================================================
# FUNÇÃO PRINCIPAL (SCANNER MESTRE V18.11 - GOLD MASTER)
# ==============================================================================

def interpretar_periodo_atividade(item_d_text, icao, item_b_raw, item_c_raw):
    """
    Versão 18.11: Base V18.3 + Correções de Regex Contínuo e Pruning de Overnight.
    """
    ...
    for match in matches:
        ...
        if tem_conteudo_data or tem_conteudo_semana:
            ...
            while k < len(tokens):
                ...
                if "/" in tok and not tok[0].isdigit():
                    ...
                    if is_overnight and eh_par_consecutivo:
                         # PRUNING: Adiciona apenas o primeiro dia do par overnight
                ...
                if tok in WEEK_MAP:
                    ...
                    if k + 2 < len(tokens) and tokens[k+1] == "TIL":
                        ...
                        if alvo_tok in WEEK_MAP:
                            ...
                            # Tratamento especial se o alvo for parte de um par overnight
                            # Se o texto original era "THU/FRI", o token alvo_tok seria "THU" ou "FRI"?
                            # O regex `[A-Za-z0-9/]+` manteria "THU/FRI".
                            # Se `alvo_tok` entrou aqui (tok in WEEK_MAP), ele é um dia limpo.
            ...
            while i < len(tokens):
                ...
                if tok[0].isdigit():
                    ...
                    if "/" in tok: 
                        ...
                        # PRUNING: Se for overnight e consecutivo, pega só o primeiro
            ...
            # --- FALLBACK DE SEMANA (Resolve TUE TIL SAT vazio) ---
